<template>
	<view class="centents">
		<view class="cu-bar bg-white">
			...
			<view class="action" @tap="toSignin()">
				<text class="text-black">注册</text>
			</view>
		</view>
		...
		<view class="main">
			...
			<view class="slogan text-gray">
				欢迎来到德莱联盟
			</view>
			<view class="inputs">
				<input type="text" placeholder="用户名/邮箱" placeholder-style="color:#aaa;font-weight:400">
				<input password placeholder="密码" placeholder-style="color:#aaa;font-weight:400">
			</view>
			<view class="submit">
				<view class="cu-btn bg-blue shadow-blur round" @tap="testFun">
					登录
				</view>
			</view>
		</view>
